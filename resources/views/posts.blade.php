<x-layout>
    ...
    {{ $posts->links() }}
        ...
        <div class="py-4 px-0 mx-auto max-w-screen-xl lg:py-4 lg:px-0 ">        
    ...
    @forelse ($posts as $post)        
                    ...
                    <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href="/posts/{{ $post['slug'] }}" class="hover:underline">{{ $post->title }}
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex items-center space-x-4">
                                    ...
                                    <span class="font-medium dark:text-white text-sm hover:underline" >
                                        {{ $post->author->name }}
                                    </span>
                                </div>
                            </a>
                            <a href="/posts/{{ $post->slug }}" class="text-sm inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                                Read more
    ...
    <p class="text-xl font-bold text-gray-800">No post found!</p>
